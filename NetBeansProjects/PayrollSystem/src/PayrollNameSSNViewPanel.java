...
public class PayrollNameSSNViewPanel extends javax.swing.JPanel {
     ...
     */
    @Override
    protected void paintComponent(Graphics g, int[] rv, Color color) {
        //if (point != null) {
        //super.paintComponent(g);
            ...
            g2d.setColor(color);
            g2d.fillRect(rv[0], rv[1], rv[2], rv[3]);
        //}
    }
    ...
    public void myInitComponents() {
        ...
        //int x = jPanel1.getX();
        //int y = jPanel1.getY();
        //int[] recval = new int[]{x,y,w,h};
        //Color c = new java.awt.Color(209, 254, 181);
        //paintComponent(jPanel1.getGraphics(), recval, c);
    ...
    */
    public void setViewData(Object[] edat){
        ...
        jLabel40.setText(edat[13].toString()); //address2
